...
const {uploadVid} = require('../middleware/upload');




router.get('/:videoid', auth,videoController.getVideo)
router.post('/upload',auth,verifyRole,uploadVid.fields([{ name: 'video', maxCount: 1 }, { name: 'pdf', maxCount: 1 }]), videoController.createVideo)
